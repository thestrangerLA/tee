...
const calculatorStateDocRef = doc(db, 'meat-cashCalculatorState', 'latest');
...
export const listenToMeatCalculatorState = (callback: (state: CashCalculatorState) => void) => {
...
export const updateMeatCalculatorState = async (newState: Partial<Omit<CashCalculatorState, 'id'>>) => {
