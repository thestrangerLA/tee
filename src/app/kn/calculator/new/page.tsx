...
import { saveCalculation } from '@/services/knCalculatorService';
import type { SavedCalculation } from '@/lib/types';
import { v4 as uuidv4 } from 'uuid';


export default function NewKNCalculationPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.replace(`/kn/calculator/${newId}`);
        } catch (error) {
             toast({
                title: "ເກີດຂໍ້ຜິດພາດ",
        ...
        <div className="flex min-h-screen w-full flex-col bg-muted/40">
            <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-xl font-bold tracking-tight">ເພີ່ມການຄຳນວນໃໝ່ (KN)</h1>
                </div>
            </header>
