...
import { listenToDocumentAccountSummary, updateDocumentAccountSummary, listenToDocumentTransactions, addDocumentTransaction, updateDocumentTransaction, deleteDocumentTransaction } from '@/services/documentAccountancyService';
...
export default function DocumentAccountancyPage() {
    ...
    useEffect(() => {
        const unsubscribeSummary = listenToDocumentAccountSummary(setSummary);
    ...
    const handleUpdateTransaction = async () => {
        ...
        try {
            await updateDocumentTransaction(editingTransaction.id, {
                ...editingTransaction,
    ...
    const handleDeleteTransaction = async (id: string) => {
        ...
        try {
            await deleteDocumentTransaction(id);
    ...
    const handleSaveSummary = async () => {
        ...
        try {
            await updateDocumentAccountSummary({ [editingField]: editingValues });
    ...
    return (
        <div className="flex min-h-screen w-full flex-col bg-muted/40">
            <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6">
                ...
                <h1 className="text-xl font-bold tracking-tight">ຈັດການບັນຊີ (ທຸລະກິດເອກະສານ)</h1>
            </header>
