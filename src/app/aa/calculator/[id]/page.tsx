...
import { getCalculation, getAllCalculations } from '@/services/aaCalculatorService';
import AACalculatorClientPage from './client-page';
...
export default async function AAProgramPage({ params }: { params: { id: string } }) {
    const { id } = params;
    ...
    return (
        <Suspense fallback={<LoadingFallback />}>
            <AACalculatorClientPage initialCalculation={calculationData} />
        </Suspense>
    );
}
