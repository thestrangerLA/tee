                                        ...
                                        <AccordionTrigger>
                                            <div className="flex justify-between w-full pr-4">
                                                ...
                                                <div className="flex items-center gap-4">
                                                    <span className="text-sm font-medium text-green-600">ກຳໄລ: {formatCurrency(sale.totalProfit || 0)} KIP</span>
                                                    <span className="text-right font-mono">{formatCurrency(sale.subtotal)} KIP</span>
                                                </div>
                                            </div>
                                        </AccordionTrigger>
